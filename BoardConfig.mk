...
TARGET_OTA_ASSERT_DEVICE := infinix-X6525B

# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := X6525B
...
TW_DEVICE_VERSION := nazephyrus | X6525B-dec
...
# Init
TARGET_INIT_VENDOR_LIB := libinit_infinix-X6525B
TARGET_RECOVERY_DEVICE_MODULES := libinit_infinix-X6525B